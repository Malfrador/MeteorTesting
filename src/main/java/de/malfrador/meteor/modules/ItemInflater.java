package de.malfrador.meteor.modules;

import de.malfrador.meteor.MeteorTesting;
...
public class ItemInflater extends Module {
    ...
    public ItemInflater() {
        super(MeteorTesting.CATEGORY, "Netty crasher", "Crashes netty threads");
    }
